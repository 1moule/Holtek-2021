...
* @{
*/
#define PRODUCT_KEY "a157751cc153460da2f6dd659f3b7b73"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "41c78125ada441d1a6f5e1bd75cf2172"
...
* @{
*/
#define Light_BYTEOFFSET                    0
#define Light_BITOFFSET                     0
#define Light_LEN                           1
#define water_BYTEOFFSET                    0
#define water_BITOFFSET                     1
#define water_LEN                           1
#define windows_BYTEOFFSET                    0
#define windows_BITOFFSET                     2
#define windows_LEN                           1

#define Temperature_RATIO                         1
#define Temperature_ADDITION                      -50
#define Temperature_MIN                           0
#define Temperature_MAX                           100
#define Humidity_RATIO                         1
#define Humidity_ADDITION                      -50
#define Humidity_MIN                           0
#define Humidity_MAX                           100
#define Lightintensity_RATIO                         1
#define Lightintensity_ADDITION                      -10
#define Lightintensity_MIN                           0
#define Lightintensity_MAX                           160
#define soil_moisture_RATIO                         1
#define soil_moisture_ADDITION                      0
...
typedef struct {
  ...
  int32_t valueHumidity;
  int32_t valueLightintensity;
  uint32_t valuesoil_moisture;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t valueLightintensity;
  uint8_t valuesoil_moisture;
} devStatus_t; 
